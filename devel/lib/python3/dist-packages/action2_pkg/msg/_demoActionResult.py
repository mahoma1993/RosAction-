...
"""autogenerated by genpy from action2_pkg/demoActionResult.msg. Do not edit."""
import codecs
import sys
...
class demoActionResult(genpy.Message):
  ...
  _type = "action2_pkg/demoActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action2_pkg/demoResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = action2_pkg.msg.demoResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = action2_pkg.msg.demoResult()
