...
"""autogenerated by genpy from action2_pkg/demoActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class demoActionFeedback(genpy.Message):
  ...
  _type = "action2_pkg/demoActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action2_pkg/demoFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = action2_pkg.msg.demoFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = action2_pkg.msg.demoFeedback()
